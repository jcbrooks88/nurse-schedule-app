...
export default function WelcomeHeader() {
  ...
  return (
    <div className="bg-white/80 rounded-2xl shadow-lg border border-accent transition-shadow hover:shadow-xl p-6 mb-12 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div>
      ...
      <div className="md:text-right text-sm text-grayDark">
        <div className="bg-teal/50 border border-accent px-4 py-2 rounded-lg shadow-sm inline-block">
          <span className="font-semibold text-grayDark">Role:</span> {user.role || 'Nurse'}
        </div>
      </div>
    </div>
  );
